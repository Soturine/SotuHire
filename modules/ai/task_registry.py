...
def default_ai_task_registry(prompts: PromptRegistry | None = None) -> AiTaskRegistry:
    """Build the complete SotuHire v2.0 task registry."""
    if prompts is None:
    ...
    definitions = (
        ...
        (
            ...
            "InterviewQuestionGenerationInput@1",
            "interview",
            "external_context_opt_in_confirmed_only",
        ),
        (
            ...
            "InterviewAnswerDraftingInput@1",
            "interview",
            "external_context_opt_in_confirmed_only",
        ),
        (
        ...
        (
            ...
            "CertificationRecommendationExplanationInput@1",
            "certification",
            "minimum_necessary_confirmed_only",
        ),
        (
            ...
            "ProjectGapRecommendationInput@1",
            "gap_project",
            "external_context_opt_in_confirmed_only",
        ),
        (
        ...
        (
            ...
            "TaxonomyMappingExplanationInput@1",
            "taxonomy",
            "no_personal_context_required",
        ),
    )
