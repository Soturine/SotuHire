...
A documentação separa referências atuais de histórico. Para conhecer o produto, comece pela visão e pelo mapa de capacidades; para implementar ou revisar dados, use a arquitetura de storage e a auditoria de integração.
...
- [Personas e casos de uso](01-product/personas-and-use-cases.md)
- [Princípios](01-product/product-principles.md)

## Arquitetura

- [Mapa de módulos](02-architecture/module-integration-map.md)
- [Career Context](02-architecture/career-context-engine.md)
- [Linhagem e deduplicação](02-architecture/data-lineage-and-deduplication.md)
- [Extensão e Perfil](02-architecture/extension-profile-bridge.md)

## Dados e persistência

- [Repositories](02-architecture/storage-repository-architecture.md)
...
- [Auditoria integral v1.11.0](00-audit/v1.11.0-full-repository-audit.md)
...
- [Local Companion](02-architecture/local-companion-api.md)
- [Captura assistida](03-business-rules/browser-assisted-capture-rules.md)
- [Testes da extensão](09-testing/browser-extension-testing.md)

## Testes e segurança

- [QA](06-engineering/qa-testing.md)
