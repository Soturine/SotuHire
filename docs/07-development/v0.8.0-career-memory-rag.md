...
## Evolução entregue na v0.9.0

A versão seguinte calibra o ranking, adiciona feedback por evidência e conecta capturas do Browser
Companion à memória, análise, tracker e dashboard. Consulte
[v0.9.0 — Browser Companion e calibração de evidências](v0.9.0-browser-extension-companion.md).
