...
A UI principal ainda continua usando os fluxos existentes. A integração v0.10 é discreta e expõe
serviços validados para as próximas telas de revisão, sem substituir os parsers antigos nem mudar
coleta autenticada.
