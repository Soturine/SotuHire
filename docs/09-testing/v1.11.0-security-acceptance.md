...
CI e CodeQL remoto aprovaram o SHA de integração. A consulta CodeQL final retornou zero alertas
abertos; as classificações residuais e suas boundaries estão no inventário de remediação.
A verificação pós-download dos assets permanece pendente até a publicação da release.
