...
O provider local é a referência de disponibilidade e privacidade. Gemini e OpenAI são opt-in. Ollama, LM Studio e endpoints OpenAI-compatible continuam como capacidade futura: a v1.9.8 não introduz um adapter novo sem cobertura suficiente de structured output e fallback.
