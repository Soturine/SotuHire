...
O site permite criar e apagar feedback. A extensão 0.9.4 envia feedback do GitHub somente quando a IA do SotuHire devolve um trace persistido; o payload não inclui README, relatório, chave ou token.
