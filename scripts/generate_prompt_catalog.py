...
FALLBACKS = {
    ...
    "interview_question_generation_v1": "Lista local vazia para revisão manual",
    "interview_answer_drafting_v1": "Rascunho local vazio sem fatos inventados",
    "star_story_structuring_v1": "Estrutura STAR local vazia e revisável",
    "follow_up_drafting_v1": "Rascunho local sem envio automático",
    "career_plan_explanation_v1": "Explicação local conservadora",
    "certification_recommendation_explanation_v1": "Candidato local que exige fonte oficial",
    "project_gap_recommendation_v1": "Projeto local candidato para revisão",
    "opportunity_enrichment_v1": "Enriquecimento local sem fatos novos",
    "taxonomy_mapping_explanation_v1": "Candidato semântico local que exige revisão",
}
STATUS_OVERRIDES = {
    ...
    "interview_question_generation_v1": "implementado",
    "interview_answer_drafting_v1": "implementado",
    "star_story_structuring_v1": "implementado",
    "follow_up_drafting_v1": "implementado",
    "career_plan_explanation_v1": "implementado",
    "certification_recommendation_explanation_v1": "implementado",
    "project_gap_recommendation_v1": "implementado",
    "opportunity_enrichment_v1": "implementado",
    "taxonomy_mapping_explanation_v1": "implementado",
}
INDIRECT_CONSUMERS = {
    ...
    "interview_question_generation_v1": ["modules/ai/career_workflows.py"],
    "interview_answer_drafting_v1": ["modules/ai/career_workflows.py"],
    "star_story_structuring_v1": ["modules/ai/career_workflows.py"],
    "follow_up_drafting_v1": ["modules/ai/career_workflows.py"],
    "career_plan_explanation_v1": ["modules/ai/career_workflows.py"],
    "certification_recommendation_explanation_v1": ["modules/ai/career_workflows.py"],
    "project_gap_recommendation_v1": ["modules/ai/career_workflows.py"],
    "opportunity_enrichment_v1": ["modules/ai/career_workflows.py"],
    "taxonomy_mapping_explanation_v1": ["modules/ai/career_workflows.py"],
}
